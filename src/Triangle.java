public class Triangle {
    ...
    public double triangleArea() {
        double triangleAArea = (this.base * this.height) / 2;
        System.out.println("The Area of this triangle is: " + triangleAArea);
        return triangleAArea;
    }
    public static int getNumOfSides() {
        return numOfSides;
    }
    public static void setNumOfSides(int numOfSides) {
        Triangle.numOfSides = numOfSides;
    }
